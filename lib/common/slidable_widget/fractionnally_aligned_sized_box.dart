...
/// A widgets that positions its child to a fraction of the total available space.
class FractionallyAlignedSizedBox extends StatelessWidget {
  /// Creates a widgets that positions its child to a fraction of the total available space.
  ///
